        ...
        <header className="relative">
            ...
            <div className="flex justify-between 2xl:gap-36 pt-10 mx-5 md:mx-10 xl:mx-20">
                <div className="flex flex-col">
                    ...
                    <a className="relative block text-sm md:text-base mt-4 md:mt-7 xl:mt-10 h-9 lg:h-12 w-32 text-center p-2 lg:p-3 bg-[#F2350C] rounded-md" href="/CVCRISTIANRINCON.pdf" target="_blank">{idioma == false ? "Descargar CV" : "Download CV"}</a>
                    <div className="mt-8 flex gap-8">
                        <a target="_blank" href="https://github.com/DibierRoot">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 md:w-10 xl:w-12 h-8 md:h-10 xl:h-12 bi bi-github" viewBox="0 0 16 16">
                        ...
                        <a target="_blank" href="https://www.linkedin.com/in/cristi%C3%A1n-camilo-rinc%C3%B3n-lozano-76b55230a">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 md:w-10 xl:w-12 h-8 md:h-10 xl:h-12 bi bi-linkedin" viewBox="0 0 16 16">
                        ...
                        <a target="_blank" href="https://www.instagram.com/dibier_oc?igsh=dzhtYjgzbzdlY2Fm">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 md:w-10 xl:w-12 h-8 md:h-10 xl:h-12 bi bi-instagram" viewBox="0 0 16 16">
                ...
                <img className="h-44 md:h-64 lg:h-72 xl:h-86 w-auto 2xl:top-28 right-1 2xl:right-66 rounded-full" src="/FotoGafas.jpg" alt="FotoDibi" />
		    </div>
        </header>
    )
}
